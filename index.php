...
<?php 
    ...
    $donnees = $resulat->fetch(PDO::FETCH_ASSOC);
?>
...
<div id="container">
        ...
        <div id="liste_membre_connecte">
            <?php
                ...
                $resultat = $pdo->query("SELECT * FROM membre WHERE date_connexion > " . (time() -3600)); // Affiche les membres s'étant connectés ou ayant posté un message dans la dernière heure (3600 secondes)
        ...
        <div id="formulaire_tchat">
            ...
            <form method="post" action="#">
                <textarea name="message" id="message" rows="5" value="<?php 
